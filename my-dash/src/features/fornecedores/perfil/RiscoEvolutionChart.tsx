      ...
      <div style={{ height: 240 }}>
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={sorted} margin={{ left: 8, right: 16, top: 4, bottom: 4 }}>
            ...
            />
            <ReferenceLine y={0.7} stroke="#A32D2D" strokeDasharray="4 4" label={{ value: "70%", fill: "#A32D2D", fontSize: 10 }} />
            <ReferenceLine y={0.4} stroke="#BA7517" strokeDasharray="4 4" label={{ value: "40%", fill: "#BA7517", fontSize: 10 }} />
            <Line
              type="monotone"
