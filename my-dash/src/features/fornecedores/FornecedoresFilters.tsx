...
export function FornecedoresFilters({ filter, onChange, total, filtered }: FornecedoresFiltersProps) {
      ...
      {(filter.search || filter.somenteAlerta || filter.risco !== "todos") && (
        <button
          ...
          style={{
            ...
            color: "var(--color-text-muted)", fontSize: "var(--text-sm)", padding: "var(--space-1) var(--space-3)",
            cursor: "pointer",
          }}
        >
          Limpar
